            ...
            <fieldset  class="scheduler-border">
                ...
                <div class="form-group">
                    <label for="tipo_documento" class="col-md-6 control-label">Palabras clave:</label>
                     <div class="col-md-4">                                                                                   
                        <input type="text" class="form-control" maxlength="50" id="palabra" name="palabra" placeholder="Palabra"  autocomplete="false">
                    </div>
                </div>
                <!--</div>-->
                <div class="form-group">
...
<div class="col-lg-12" >
        ...
        <div class="card-header">
          <i class="fa fa-table"></i> Consultar Archivo</div>
        <div class="card-body">
				<div class="card mb-3">
					<div class="card-body">
						<div class="table-responsive">
							<div id="tconsarchivo"></div>
						</div>
					</div>
...
function fn_consultar(){
	...
	if (palabra!='') {
		...
		danger("Error, Debe ingresar una palabra válida");
	}
